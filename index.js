...
console.log("XXXXXXX       XXXXXXX               AAA               NNNNNNNN        NNNNNNNN               AAA               XXXXXXX       XXXXXXX");
console.log("X:::::X       X:::::X              A:::A              N:::::::N       N::::::N              A:::A              X:::::X       X:::::X");
console.log("X:::::X       X:::::X             A:::::A             N::::::::N      N::::::N             A:::::A             X:::::X       X:::::X");
console.log("X::::::X     X::::::X            A:::::::A            N:::::::::N     N::::::N            A:::::::A            X::::::X     X::::::X");
console.log("XXX:::::X   X:::::XXX           A:::::::::A           N::::::::::N    N::::::N           A:::::::::A           XXX:::::X   X:::::XXX");
console.log("   X:::::X X:::::X             A:::::A:::::A          N:::::::::::N   N::::::N          A:::::A:::::A             X:::::X X:::::X   ");
console.log("    X:::::X:::::X             A:::::A A:::::A         N:::::::N::::N  N::::::N         A:::::A A:::::A             X:::::X:::::X    ");
console.log("     X:::::::::X             A:::::A   A:::::A        N::::::N N::::N N::::::N        A:::::A   A:::::A             X:::::::::X     ");
console.log("     X:::::::::X            A:::::A     A:::::A       N::::::N  N::::N:::::::N       A:::::A     A:::::A            X:::::::::X     ");
console.log("    X:::::X:::::X          A:::::AAAAAAAAA:::::A      N::::::N   N:::::::::::N      A:::::AAAAAAAAA:::::A          X:::::X:::::X    ");
console.log("   X:::::X X:::::X        A:::::::::::::::::::::A     N::::::N    N::::::::::N     A:::::::::::::::::::::A        X:::::X X:::::X   ");
console.log("XXX:::::X   X:::::XXX    A:::::AAAAAAAAAAAAA:::::A    N::::::N     N:::::::::N    A:::::AAAAAAAAAAAAA:::::A    XXX:::::X   X:::::XXX");
console.log("X::::::X     X::::::X   A:::::A             A:::::A   N::::::N      N::::::::N   A:::::A             A:::::A   X::::::X     X::::::X");
console.log("X:::::X       X:::::X  A:::::A               A:::::A  N::::::N       N:::::::N  A:::::A               A:::::A  X:::::X       X:::::X");
console.log("X:::::X       X:::::X A:::::A                 A:::::A N::::::N        N::::::N A:::::A                 A:::::A X:::::X       X:::::X");
console.log("XXXXXXX       XXXXXXXAAAAAAA                   AAAAAAANNNNNNNN         NNNNNNNAAAAAAA                   AAAAAAAXXXXXXX       XXXXXXX");
...
requestify.get('https://ampedscripts.nl/version.txt')
  .then(function(response) {
      ...
      if (response.getBody() === `${version}\n`) {
          ...
          console.log(`\n\nThis version is outdated make sure to npm i x-script-converter\n\nCurrent Version: ${version}\nNewest Version: ${responselmae}`);
          process.exit();
     }
});
